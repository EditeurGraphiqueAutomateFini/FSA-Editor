    ...
    var local_data_handling = function(object,mode,options){
        ...
        var dataSolid = _.cloneDeep(data);
          ...
          switch(mode) {
              case "view":
                  // initiate viewmode
                  viewmode.init(viewmode.extractStates(data),data[0],options);
                  // handel reset
                  $("button.reset").click(function(){
                      ...
                      viewmode.init(viewmode.extractStates(parsedDataLiquid),parsedDataLiquid[0],options);
              ...
              case "edit":
                  // loading view mode
                  var loadedViewMode = viewmode.init(viewmode.extractStates(data),data[0],options);
                  ...
                  $("button.reset").click(function(){
                      ...
                      var newLoadedViewMode = viewmode.init(viewmode.extractStates(parsedDataLiquid),parsedDataLiquid[0],options);
